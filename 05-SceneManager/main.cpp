...
#define BACKGROUND_COLOR D3DXCOLOR(0.7098f, 0.9215f, 0.9490f, 1.0f)
...
int WINAPI WinMain(
	...
	SetWindowPos(hWnd, 0, 0, 0, SCREEN_WIDTH*2, static_cast<int>(SCREEN_HEIGHT*1.9), SWP_NOMOVE | SWP_NOOWNERZORDER | SWP_NOZORDER);
